...
| **Daily Market Briefing** | 홈 대시보드에서 장 상태, 국가별 체제, 오늘 우선 볼 종목, 다가오는 이벤트를 한 장의 브리핑으로 요약 |
...
| **포트폴리오 추천 레이아웃 안정화** | 조건 추천/최적 추천 패널은 폭이 좁아지면 자연스럽게 세로로 정렬되고, 권장 비중 테이블은 비율을 다시 잡아 깨지기보다 가로 스크롤로 안정적으로 유지 |
