...
CHECKS = [
    ...
    ApiCheck("GET", "/api/stock/005930.KS/detail"),
    ApiCheck("GET", "/api/stock/005930.KS/chart"),
    ApiCheck("GET", "/api/stock/005930.KS/technical-summary"),
    ApiCheck("GET", "/api/stock/005930.KS/pivot-points"),
    ApiCheck("GET", "/api/search?q=005930"),
    ApiCheck("GET", "/api/watchlist", expected_status=401, expected_error_code="SP-6014"),
    ApiCheck("POST", "/api/watchlist/005930.KS?country_code=KR", expected_status=401, expected_error_code="SP-6014"),
    ApiCheck("DELETE", "/api/watchlist/005930.KS", expected_status=401, expected_error_code="SP-6014"),
    ApiCheck("GET", "/api/compare?tickers=005930.KS,000660.KS"),
