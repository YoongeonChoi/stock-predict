...
export interface OpportunityItem {
  ...
  flow_accumulation_score?: number | null;
  sector_catalyst_score?: number | null;
  score_breakdown?: Record<string, unknown> | null;
  flow_data_status?: string | null;
  quality_data_status?: string | null;
  entry_style?: string | null;
  recommended_entry_condition?: string | null;
  quant_score: number;
  up_probability: number;
  confidence: number;
  predicted_return_pct: number;
