...
ROUTE_CONTRACTS: tuple[RouteContract, ...] = (
    ...
    RouteContract(
        ...
        optional_upgrade_state=("다가오는 주요 일정", "월간 체크포인트"),
    ...
    RouteContract(
        ...
        optional_upgrade_state=("공식 기관 원문",),
    ...
    RouteContract(
        ...
        optional_upgrade_state=("저장한 관심종목", "심화 추적 시작"),
        ...
        smoke=BrowserSmokeExpectation(
            ...
            any_of_texts=("저장한 관심종목", "관심종목은 로그인 후 사용할 수 있습니다", "심화 추적 시작"),
            include_in_browser_smoke=True,
            include_in_deployed_frontend_smoke=True,
        ),
...
LIVE_API_SMOKE_CHECKS: tuple[ApiSmokeCheck, ...] = (
    ...
    ApiSmokeCheck(
        "watchlist-tracking-auth",
        "GET",
        "/api/watchlist/005930.KS/tracking-detail",
        expected_status=401,
        expected_error_code="SP-6014",
        operation_kind="auth-read",
    ),
    ApiSmokeCheck(
        "watchlist-tracking-auth-post",
        "POST",
        "/api/watchlist/005930.KS/tracking?country_code=KR",
        expected_status=401,
        expected_error_code="SP-6014",
        operation_kind="auth-write",
    ),
    ApiSmokeCheck(
        "watchlist-tracking-auth-delete",
        "DELETE",
        "/api/watchlist/005930.KS/tracking",
        expected_status=401,
        expected_error_code="SP-6014",
        operation_kind="auth-write",
    ),
